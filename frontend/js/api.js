...
async function apiGetAllUsers() { return await apiFetch('/admin/users'); }
async function apiCreateUser(data) { return await apiFetch('/admin/users', 'POST', data); }
async function apiUpdateUser(id, data) { return await apiFetch('/admin/users/' + id, 'PUT', data); }
async function apiDeleteUser(id)  { return await apiFetch('/admin/users/' + id, 'DELETE'); }